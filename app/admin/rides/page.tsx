  ...
  return (
    <div className="space-y-8">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div>
          <h1 className="text-3xl font-black text-slate-900 uppercase tracking-tight mb-2">Park Rides</h1>
      ...
      <div className="flex gap-2 p-1.5 bg-slate-200/50 rounded-[24px] w-fit">
        <Link href="/admin/rides" className="flex items-center gap-3 px-8 py-3 rounded-[18px] text-[10px] font-black uppercase tracking-widest transition-all bg-white text-blue-600 shadow-sm">
          <Map className="w-4 h-4" />
          All Rides
        </Link>
        <Link href="/admin/rides/categories" className="flex items-center gap-3 px-8 py-3 rounded-[18px] text-[10px] font-black uppercase tracking-widest transition-all text-slate-400 hover:text-slate-600">
