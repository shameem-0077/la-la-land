...
import { Plus, Search, Edit2, Trash2, Map, Layers, Image as ImageIcon } from "lucide-react";
                  ...
                  <tr key={cat.id} className="group hover:bg-slate-50/50 transition-colors">
                    <td className="px-8 py-6">
                      <div className="flex items-center gap-4">
                        <div className="w-12 h-12 rounded-xl bg-slate-100 overflow-hidden relative shrink-0 border border-slate-200">
                          {cat.cover_image ? (
                            <img src={cat.cover_image} className="w-full h-full object-cover" />
                          ) : (
                    ...
                    <td className="px-8 py-6">
                      <div className="flex items-center justify-end gap-2">
                        <Link 
                          href={`/admin/rides/categories/edit/${cat.id}`}
