...
import { Ticket, Menu, X, ChevronRight, MessageCircle } from "lucide-react";
        ...
        <div className="flex items-center gap-3 md:gap-5 relative z-[110]">
          ...
          {!isMobileMenuOpen && (
            <NextLink
              ...
              className="w-10 h-10 md:w-11 md:h-11 flex items-center justify-center rounded-full bg-[#25D366] hover:bg-[#1dbd5a] transition-all shadow-lg hover:scale-110"
